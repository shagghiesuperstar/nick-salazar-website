# Static audit — 2026-09-04T23:10:12.997698-05:00

Result: 0 FAIL · 0 WARN · 40 PASS (of 40)

## [PASS] file sizes (bytes) index/styles/tokens/app
    index.html=28827 styles.css=33645 tokens.css=9423 app.js=13113 (advisory caps: app≤~10KB, styles≤60KB)
...
## [PASS] HTML: pre-publication contact dependency comment present
    L359: <!-- PRE-PUBLICATION DEPENDENCY: contact destination (phone/email) not supplied; wire before publishing -->

## [PASS] HTML: no invented contact (mailto:/tel:/@ addresses)
    none
...
## [PASS] CSS: no italic headings (gate 38a) — any font-style:italic lines listed for manual check
    L547: .prose em { font-style: italic; }

## [PASS] CSS: overflow-x: clip on html and body (gate 34)
    L11: overflow-x: clip;
    L22: overflow-x: clip;
    L825: overflow-x: auto;

## [PASS] CSS: prefers-reduced-motion block present (gate 27)
    L384: @media (hover: hover) and (pointer: fine) and (prefers-reduced-motion: no-preference) {
    L391: @media (prefers-reduced-motion: no-preference) {
    L900: @media (prefers-reduced-motion: reduce) {

## [PASS] CSS: pointer:coarse / hover:none guards for pointer light
    L186: @media (pointer: coarse) {
    L768: @media (pointer: coarse) { .btn--sm { height: var(--control-height); } }

## [PASS] CSS: scroll-driven animation + @supports guard
    L390: @supports (animation-timeline: view()) {
    L395: animation-timeline: --plate;
    L400: animation-timeline: --plate;
    L404: animation-timeline: --plate;
...
## [PASS] CSS: overflow-wrap: anywhere on display
    ...
    L342: overflow-wrap: anywhere;
    L354: overflow-wrap: anywhere;
